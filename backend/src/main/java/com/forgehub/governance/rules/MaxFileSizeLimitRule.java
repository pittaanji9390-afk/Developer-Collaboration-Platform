...
/**
 * MaxFileSizeLimitRule
 * Governance evaluation rule: Enforces maximum Git blob size limit (100MB) without Git LFS
 */
@Slf4j
@Component
public class MaxFileSizeLimitRule {

    private static final String RULE_NAME = "MaxFileSizeLimitRule";
    private static final String DESCRIPTION = "Enforces maximum Git blob size limit (100MB) without Git LFS";
