...
/**
 * CodeOwnersApprovalPolicyRule
 * Governance evaluation rule: Enforces mandatory CODEOWNERS team approvals
 */
@Slf4j
@Component
public class CodeOwnersApprovalPolicyRule {

    private static final String RULE_NAME = "CodeOwnersApprovalPolicyRule";
    private static final String DESCRIPTION = "Enforces mandatory CODEOWNERS team approvals";
