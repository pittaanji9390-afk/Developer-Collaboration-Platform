...
/**
 * TwoFactorAuthEnforcementRule
 * Governance evaluation rule: Enforces TOTP 2FA for all organization team members
 */
@Slf4j
@Component
public class TwoFactorAuthEnforcementRule {

    private static final String RULE_NAME = "TwoFactorAuthEnforcementRule";
    private static final String DESCRIPTION = "Enforces TOTP 2FA for all organization team members";
