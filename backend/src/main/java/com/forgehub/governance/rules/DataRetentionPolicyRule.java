...
/**
 * DataRetentionPolicyRule
 * Governance evaluation rule: Automates purge of ephemeral CI artifacts past 90 days TTL
 */
@Slf4j
@Component
public class DataRetentionPolicyRule {

    private static final String RULE_NAME = "DataRetentionPolicyRule";
    private static final String DESCRIPTION = "Automates purge of ephemeral CI artifacts past 90 days TTL";
