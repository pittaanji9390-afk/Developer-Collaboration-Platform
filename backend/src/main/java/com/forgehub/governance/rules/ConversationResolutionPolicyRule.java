...
/**
 * ConversationResolutionPolicyRule
 * Governance evaluation rule: Enforces all inline review threads must be resolved
 */
@Slf4j
@Component
public class ConversationResolutionPolicyRule {

    private static final String RULE_NAME = "ConversationResolutionPolicyRule";
    private static final String DESCRIPTION = "Enforces all inline review threads must be resolved";
