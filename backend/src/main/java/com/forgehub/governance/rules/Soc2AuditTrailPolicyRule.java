...
/**
 * Soc2AuditTrailPolicyRule
 * Governance evaluation rule: Validates immutable audit logging for SOC2 Type II compliance
 */
@Slf4j
@Component
public class Soc2AuditTrailPolicyRule {

    private static final String RULE_NAME = "Soc2AuditTrailPolicyRule";
    private static final String DESCRIPTION = "Validates immutable audit logging for SOC2 Type II compliance";
