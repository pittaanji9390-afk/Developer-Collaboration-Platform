...
/**
 * MergeQueueSpeculativeBuildRule
 * Governance evaluation rule: Validates speculative merge train build results
 */
@Slf4j
@Component
public class MergeQueueSpeculativeBuildRule {

    private static final String RULE_NAME = "MergeQueueSpeculativeBuildRule";
    private static final String DESCRIPTION = "Validates speculative merge train build results";
