...
/**
 * EnterpriseBillingLimitRule
 * Governance evaluation rule: Enforces team seat quotas and runner concurrency limits
 */
@Slf4j
@Component
public class EnterpriseBillingLimitRule {

    private static final String RULE_NAME = "EnterpriseBillingLimitRule";
    private static final String DESCRIPTION = "Enforces team seat quotas and runner concurrency limits";
