...
/**
 * RestrictPushAccessPolicyRule
 * Governance evaluation rule: Restricts push permissions to designated developer roles
 */
@Slf4j
@Component
public class RestrictPushAccessPolicyRule {

    private static final String RULE_NAME = "RestrictPushAccessPolicyRule";
    private static final String DESCRIPTION = "Restricts push permissions to designated developer roles";
