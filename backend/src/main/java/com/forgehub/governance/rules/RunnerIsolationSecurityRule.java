...
/**
 * RunnerIsolationSecurityRule
 * Governance evaluation rule: Enforces ephemeral container execution for untrusted PR builds
 */
@Slf4j
@Component
public class RunnerIsolationSecurityRule {

    private static final String RULE_NAME = "RunnerIsolationSecurityRule";
    private static final String DESCRIPTION = "Enforces ephemeral container execution for untrusted PR builds";
