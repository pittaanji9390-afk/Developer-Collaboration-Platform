...
/**
 * GplCopyleftIsolationPolicyRule
 * Governance evaluation rule: Checks proprietary code does not link to GPL/AGPL libraries
 */
@Slf4j
@Component
public class GplCopyleftIsolationPolicyRule {

    private static final String RULE_NAME = "GplCopyleftIsolationPolicyRule";
    private static final String DESCRIPTION = "Checks proprietary code does not link to GPL/AGPL libraries";
