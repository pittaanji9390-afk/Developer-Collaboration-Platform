...
/**
 * SignedCommitsPolicyRule
 * Governance evaluation rule: Verifies GPG cryptographic signatures on commits
 */
@Slf4j
@Component
public class SignedCommitsPolicyRule {

    private static final String RULE_NAME = "SignedCommitsPolicyRule";
    private static final String DESCRIPTION = "Verifies GPG cryptographic signatures on commits";
