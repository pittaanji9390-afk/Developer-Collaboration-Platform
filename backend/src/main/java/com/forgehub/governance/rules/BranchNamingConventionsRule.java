...
/**
 * BranchNamingConventionsRule
 * Governance evaluation rule: Enforces branch naming patterns (feature/*, bugfix/*, release/*)
 */
@Slf4j
@Component
public class BranchNamingConventionsRule {

    private static final String RULE_NAME = "BranchNamingConventionsRule";
    private static final String DESCRIPTION = "Enforces branch naming patterns (feature/*, bugfix/*, release/*)";
