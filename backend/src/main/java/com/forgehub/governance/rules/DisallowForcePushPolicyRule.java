...
/**
 * DisallowForcePushPolicyRule
 * Governance evaluation rule: Blocks git push --force on protected branches
 */
@Slf4j
@Component
public class DisallowForcePushPolicyRule {

    private static final String RULE_NAME = "DisallowForcePushPolicyRule";
    private static final String DESCRIPTION = "Blocks git push --force on protected branches";
