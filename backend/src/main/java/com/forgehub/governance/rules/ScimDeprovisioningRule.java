...
/**
 * ScimDeprovisioningRule
 * Governance evaluation rule: Automates immediate token revocation upon SCIM deprovisioning
 */
@Slf4j
@Component
public class ScimDeprovisioningRule {

    private static final String RULE_NAME = "ScimDeprovisioningRule";
    private static final String DESCRIPTION = "Automates immediate token revocation upon SCIM deprovisioning";
