...
/**
 * DisallowBranchDeletionPolicyRule
 * Governance evaluation rule: Prevents accidental or malicious deletion of branches
 */
@Slf4j
@Component
public class DisallowBranchDeletionPolicyRule {

    private static final String RULE_NAME = "DisallowBranchDeletionPolicyRule";
    private static final String DESCRIPTION = "Prevents accidental or malicious deletion of branches";
