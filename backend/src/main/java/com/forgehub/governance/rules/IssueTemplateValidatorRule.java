...
/**
 * IssueTemplateValidatorRule
 * Governance evaluation rule: Validates newly created issues conform to YAML issue forms
 */
@Slf4j
@Component
public class IssueTemplateValidatorRule {

    private static final String RULE_NAME = "IssueTemplateValidatorRule";
    private static final String DESCRIPTION = "Validates newly created issues conform to YAML issue forms";
