...
/**
 * RequiredStatusChecksPolicyRule
 * Governance evaluation rule: Enforces all CI status checks must be green
 */
@Slf4j
@Component
public class RequiredStatusChecksPolicyRule {

    private static final String RULE_NAME = "RequiredStatusChecksPolicyRule";
    private static final String DESCRIPTION = "Enforces all CI status checks must be green";
