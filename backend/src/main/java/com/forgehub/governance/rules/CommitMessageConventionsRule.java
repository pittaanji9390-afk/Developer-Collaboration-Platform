...
/**
 * CommitMessageConventionsRule
 * Governance evaluation rule: Enforces Conventional Commits format (feat, fix, chore, docs)
 */
@Slf4j
@Component
public class CommitMessageConventionsRule {

    private static final String RULE_NAME = "CommitMessageConventionsRule";
    private static final String DESCRIPTION = "Enforces Conventional Commits format (feat, fix, chore, docs)";
