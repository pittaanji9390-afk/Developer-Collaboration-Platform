...
/**
 * CodeCoverageThresholdRule
 * Governance evaluation rule: Enforces minimum 80% automated unit test code coverage
 */
@Slf4j
@Component
public class CodeCoverageThresholdRule {

    private static final String RULE_NAME = "CodeCoverageThresholdRule";
    private static final String DESCRIPTION = "Enforces minimum 80% automated unit test code coverage";
