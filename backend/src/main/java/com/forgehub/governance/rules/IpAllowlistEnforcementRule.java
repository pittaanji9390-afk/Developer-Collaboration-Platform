...
/**
 * IpAllowlistEnforcementRule
 * Governance evaluation rule: Restricts API access to authorized enterprise CIDR blocks
 */
@Slf4j
@Component
public class IpAllowlistEnforcementRule {

    private static final String RULE_NAME = "IpAllowlistEnforcementRule";
    private static final String DESCRIPTION = "Restricts API access to authorized enterprise CIDR blocks";
