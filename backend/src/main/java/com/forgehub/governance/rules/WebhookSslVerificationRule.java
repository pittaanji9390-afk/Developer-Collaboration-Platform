...
/**
 * WebhookSslVerificationRule
 * Governance evaluation rule: Enforces strict TLS/SSL certificate validation on webhooks
 */
@Slf4j
@Component
public class WebhookSslVerificationRule {

    private static final String RULE_NAME = "WebhookSslVerificationRule";
    private static final String DESCRIPTION = "Enforces strict TLS/SSL certificate validation on webhooks";
