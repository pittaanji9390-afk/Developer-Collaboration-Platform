...
/**
 * SamlSsoSessionTimeoutRule
 * Governance evaluation rule: Enforces enterprise SAML SSO maximum session duration
 */
@Slf4j
@Component
public class SamlSsoSessionTimeoutRule {

    private static final String RULE_NAME = "SamlSsoSessionTimeoutRule";
    private static final String DESCRIPTION = "Enforces enterprise SAML SSO maximum session duration";
