...
/**
 * PullRequestTemplatePolicyRule
 * Governance evaluation rule: Validates PR description contains required template checklist
 */
@Slf4j
@Component
public class PullRequestTemplatePolicyRule {

    private static final String RULE_NAME = "PullRequestTemplatePolicyRule";
    private static final String DESCRIPTION = "Validates PR description contains required template checklist";
