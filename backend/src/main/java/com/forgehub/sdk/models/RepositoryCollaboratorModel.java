...
/**
 * RepositoryCollaboratorModel
 * Represents a collaborator with specific RBAC permission levels
 */
@Data
@Builder
@NoArgsConstructor
...
public class RepositoryCollaboratorModel implements Serializable {
