...
@Component
public class HardcodedCredentialsAnalyzer {

    private static final String RULE_ID = "FORGEHUB-CWE-798";
    ...
    private static final String DESCRIPTION = "Detects hardcoded passwords, tokens, API secrets in variable declarations";
        ...
        for (int i = 0; i < lines.length; i++) {
            ...
            if (m.find() && isVulnerableContext(line)) {
                findings.add(Finding.builder()
                        .ruleId(RULE_ID)
                        .title("HardcodedCredentials Finding")
