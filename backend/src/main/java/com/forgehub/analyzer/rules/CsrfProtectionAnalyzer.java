...
@Component
public class CsrfProtectionAnalyzer {

    private static final String RULE_ID = "FORGEHUB-CWE-352";
    private static final String CWE_ID = "CWE-352";
    private static final Severity SEVERITY = Severity.MEDIUM;
    private static final Category CATEGORY = Category.BROKEN_AUTH;
    private static final String DESCRIPTION = "Detects disabled CSRF protection on state-changing endpoints without custom token verification";
