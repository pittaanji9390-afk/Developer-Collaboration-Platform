...
public class DockerSecurityAnalyzer {
    ...
    private static final String DESCRIPTION = "Detects root user execution, unpinned base images, and missing healthcheck in Dockerfile";
