...
@Component
public class KubernetesSecurityAnalyzer {

    private static final String RULE_ID = "FORGEHUB-CWE-250";
    ...
    private static final String DESCRIPTION = "Detects privileged containers, hostPID/hostNetwork, and missing securityContext";
        ...
        for (int i = 0; i < lines.length; i++) {
            ...
            if (m.find() && isVulnerableContext(line)) {
                findings.add(Finding.builder()
                        .ruleId(RULE_ID)
                        .title("KubernetesSecurity Finding")
