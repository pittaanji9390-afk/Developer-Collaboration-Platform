...
@Component
public class InsecureDeserializationAnalyzer {

    private static final String RULE_ID = "FORGEHUB-CWE-502";
    ...
    private static final String DESCRIPTION = "Detects unconstrained ObjectInputStream.readObject and XMLDecoder parsing";
        ...
        for (int i = 0; i < lines.length; i++) {
            ...
            if (m.find() && isVulnerableContext(line)) {
                findings.add(Finding.builder()
                        .ruleId(RULE_ID)
                        .title("InsecureDeserialization Finding")
