...
@Component
public class OpenRedirectAnalyzer {

    private static final String RULE_ID = "FORGEHUB-CWE-601";
    private static final String CWE_ID = "CWE-601";
    ...
    private static final String DESCRIPTION = "Detects unvalidated user input in HTTP 302/301 Location redirect headers";
