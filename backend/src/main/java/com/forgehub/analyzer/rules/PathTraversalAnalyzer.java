...
@Component
public class PathTraversalAnalyzer {

    private static final String RULE_ID = "FORGEHUB-CWE-22";
    private static final String CWE_ID = "CWE-22";
    ...
    private static final String DESCRIPTION = "Detects user-controlled file path access without path canonicalization normalization";
