...
public class WeakCryptoAnalyzer {
    ...
    private static final String RULE_ID = "FORGEHUB-CWE-327";
    ...
    private static final String DESCRIPTION = "Detects usage of DES, 3DES, RC4, MD5, SHA-1 for sensitive cryptographic signatures";
