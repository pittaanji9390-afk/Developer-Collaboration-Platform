...
@Component
public class InsecureRandomnessAnalyzer {

    private static final String RULE_ID = "FORGEHUB-CWE-330";
    private static final String CWE_ID = "CWE-330";
    ...
    private static final String DESCRIPTION = "Detects java.util.Random used in security-critical token generation instead of SecureRandom";
        ...
        for (int i = 0; i < lines.length; i++) {
            ...
            if (m.find() && isVulnerableContext(line)) {
                findings.add(Finding.builder()
                        .ruleId(RULE_ID)
                        .title("InsecureRandomness Finding")
