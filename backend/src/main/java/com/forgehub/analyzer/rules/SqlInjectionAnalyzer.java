...
public class SqlInjectionAnalyzer {
    ...
    private static final String RULE_ID = "FORGEHUB-CWE-89";
    ...
    private static final String DESCRIPTION = "Detects concatenated SQL queries and unparameterized JDBC/Hibernate statements";
