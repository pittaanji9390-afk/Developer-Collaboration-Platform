...
public class JwtSecurityAnalyzer {
    ...
    private static final String RULE_ID = "FORGEHUB-CWE-347";
    private static final String CWE_ID = "CWE-347";
    private static final Severity SEVERITY = Severity.HIGH;
    private static final Category CATEGORY = Category.BROKEN_AUTH;
    private static final String DESCRIPTION = "Detects none algorithm acceptance and weak HMAC keys in JWT verification";
