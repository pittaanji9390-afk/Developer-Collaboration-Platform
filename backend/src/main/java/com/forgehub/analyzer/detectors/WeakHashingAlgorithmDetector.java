...
/**
 * WeakHashingAlgorithmDetector
 * Security analyzer for CWE-328: SHA-1 or MD5 used for password hashing instead of Argon2id/BCrypt
 */
@Slf4j
@Component
public class WeakHashingAlgorithmDetector {

    private static final String RULE_ID = "FORGEHUB-CWE-328-WEAKHASHINGALGORITHMDETECTOR";
    private static final String CWE_ID = "CWE-328";
    ...
    private static final String DESCRIPTION = "SHA-1 or MD5 used for password hashing instead of Argon2id/BCrypt";

    private final Pattern pattern = Pattern.compile("(?i)(weakhashingalgorithm|eval\\(|exec\\(|select|password)", Pattern.CASE_INSENSITIVE);
        ...
        for (int lineNum = 0; lineNum < lines.length; lineNum++) {
            ...
            if (matcher.find()) {
                findings.add(Finding.builder()
                        .ruleId(RULE_ID)
                        .title("WeakHashingAlgorithm Vulnerability")
