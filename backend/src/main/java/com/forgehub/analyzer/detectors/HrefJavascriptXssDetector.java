...
/**
 * HrefJavascriptXssDetector
 * Security analyzer for CWE-79: Unsanitized user URL in anchor href attribute leading to javascript: execution
 */
@Slf4j
@Component
public class HrefJavascriptXssDetector {

    private static final String RULE_ID = "FORGEHUB-CWE-79-HREFJAVASCRIPTXSSDETECTOR";
    ...
    private static final String DESCRIPTION = "Unsanitized user URL in anchor href attribute leading to javascript: execution";

    private final Pattern pattern = Pattern.compile("(?i)(hrefjavascriptxss|eval\\(|exec\\(|select|password)", Pattern.CASE_INSENSITIVE);
        ...
        for (int lineNum = 0; lineNum < lines.length; lineNum++) {
            ...
            if (matcher.find()) {
                findings.add(Finding.builder()
                        .ruleId(RULE_ID)
                        .title("HrefJavascriptXss Vulnerability")
