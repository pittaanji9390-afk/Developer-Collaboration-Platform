 ...
 * Security analyzer for CWE-1321: Object deep merge utility vulnerable to __proto__ key injection
 */
@Slf4j
@Component
public class PrototypePollutionDetector {

    private static final String RULE_ID = "FORGEHUB-CWE-1321-PROTOTYPEPOLLUTIONDETECTOR";
    private static final String CWE_ID = "CWE-1321";
    ...
    private static final String DESCRIPTION = "Object deep merge utility vulnerable to __proto__ key injection";

    private final Pattern pattern = Pattern.compile("(?i)(prototypepollution|eval\\(|exec\\(|select|password)", Pattern.CASE_INSENSITIVE);
        ...
        for (int lineNum = 0; lineNum < lines.length; lineNum++) {
            ...
            if (matcher.find()) {
                findings.add(Finding.builder()
                        .ruleId(RULE_ID)
                        .title("PrototypePollution Vulnerability")
