...
/**
 * K8sMissingResourceLimitsDetector
 * Security analyzer for CWE-770: Kubernetes container spec missing CPU and memory resource limits
 */
@Slf4j
@Component
public class K8sMissingResourceLimitsDetector {

    private static final String RULE_ID = "FORGEHUB-CWE-770-K8SMISSINGRESOURCELIMITSDETECTOR";
    ...
    private static final String DESCRIPTION = "Kubernetes container spec missing CPU and memory resource limits";

    private final Pattern pattern = Pattern.compile("(?i)(k8smissingresourcelimits|eval\\(|exec\\(|select|password)", Pattern.CASE_INSENSITIVE);
        ...
        for (int lineNum = 0; lineNum < lines.length; lineNum++) {
            ...
            if (matcher.find()) {
                findings.add(Finding.builder()
                        .ruleId(RULE_ID)
                        .title("K8sMissingResourceLimits Vulnerability")
