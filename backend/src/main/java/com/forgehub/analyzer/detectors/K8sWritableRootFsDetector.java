...
/**
 * K8sWritableRootFsDetector
 * Security analyzer for CWE-732: Kubernetes container spec missing readOnlyRootFilesystem: true
 */
@Slf4j
@Component
public class K8sWritableRootFsDetector {

    private static final String RULE_ID = "FORGEHUB-CWE-732-K8SWRITABLEROOTFSDETECTOR";
    private static final String CWE_ID = "CWE-732";
    ...
    private static final String DESCRIPTION = "Kubernetes container spec missing readOnlyRootFilesystem: true";

    private final Pattern pattern = Pattern.compile("(?i)(k8swritablerootfs|eval\\(|exec\\(|select|password)", Pattern.CASE_INSENSITIVE);
        ...
        for (int lineNum = 0; lineNum < lines.length; lineNum++) {
            ...
            if (matcher.find()) {
                findings.add(Finding.builder()
                        .ruleId(RULE_ID)
                        .title("K8sWritableRootFs Vulnerability")
