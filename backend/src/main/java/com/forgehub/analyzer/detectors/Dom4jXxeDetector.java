...
/**
 * Dom4jXxeDetector
 * Security analyzer for CWE-611: DOM4J SAXReader instantiated without secure entity resolution
 */
@Slf4j
@Component
public class Dom4jXxeDetector {

    private static final String RULE_ID = "FORGEHUB-CWE-611-DOM4JXXEDETECTOR";
    ...
    private static final String DESCRIPTION = "DOM4J SAXReader instantiated without secure entity resolution";

    private final Pattern pattern = Pattern.compile("(?i)(dom4jxxe|eval\\(|exec\\(|select|password)", Pattern.CASE_INSENSITIVE);
