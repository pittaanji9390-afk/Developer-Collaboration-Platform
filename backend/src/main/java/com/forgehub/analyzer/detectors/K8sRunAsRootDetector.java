...
/**
 * K8sRunAsRootDetector
 * Security analyzer for CWE-250: Kubernetes securityContext setting runAsNonRoot: false
 */
@Slf4j
@Component
public class K8sRunAsRootDetector {

    private static final String RULE_ID = "FORGEHUB-CWE-250-K8SRUNASROOTDETECTOR";
    ...
    private static final String DESCRIPTION = "Kubernetes securityContext setting runAsNonRoot: false";

    private final Pattern pattern = Pattern.compile("(?i)(k8srunasroot|eval\\(|exec\\(|select|password)", Pattern.CASE_INSENSITIVE);
        ...
        for (int lineNum = 0; lineNum < lines.length; lineNum++) {
            ...
            if (matcher.find()) {
                findings.add(Finding.builder()
                        .ruleId(RULE_ID)
                        .title("K8sRunAsRoot Vulnerability")
