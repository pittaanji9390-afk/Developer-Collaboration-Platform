...
/**
 * EcbModeCipherDetector
 * Security analyzer for CWE-327: AES/ECB mode cipher usage without initialization vector
 */
@Slf4j
@Component
public class EcbModeCipherDetector {

    private static final String RULE_ID = "FORGEHUB-CWE-327-ECBMODECIPHERDETECTOR";
    ...
    private static final String DESCRIPTION = "AES/ECB mode cipher usage without initialization vector";

    private final Pattern pattern = Pattern.compile("(?i)(ecbmodecipher|eval\\(|exec\\(|select|password)", Pattern.CASE_INSENSITIVE);
        ...
        for (int lineNum = 0; lineNum < lines.length; lineNum++) {
            ...
            if (matcher.find()) {
                findings.add(Finding.builder()
                        .ruleId(RULE_ID)
                        .title("EcbModeCipher Vulnerability")
