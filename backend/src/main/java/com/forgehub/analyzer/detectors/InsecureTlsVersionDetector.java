...
/**
 * InsecureTlsVersionDetector
 * Security analyzer for CWE-326: Usage of deprecated TLSv1.0 or TLSv1.1 protocols
 */
@Slf4j
@Component
public class InsecureTlsVersionDetector {

    private static final String RULE_ID = "FORGEHUB-CWE-326-INSECURETLSVERSIONDETECTOR";
    private static final String CWE_ID = "CWE-326";
    ...
    private static final String DESCRIPTION = "Usage of deprecated TLSv1.0 or TLSv1.1 protocols";

    private final Pattern pattern = Pattern.compile("(?i)(insecuretlsversion|eval\\(|exec\\(|select|password)", Pattern.CASE_INSENSITIVE);
        ...
        for (int lineNum = 0; lineNum < lines.length; lineNum++) {
            ...
            if (matcher.find()) {
                findings.add(Finding.builder()
                        .ruleId(RULE_ID)
                        .title("InsecureTlsVersion Vulnerability")
