...
/**
 * MissingFunctionLevelAuthDetector
 * Security analyzer for CWE-285: Admin controller endpoint missing @PreAuthorize or hasRole annotation
 */
@Slf4j
@Component
public class MissingFunctionLevelAuthDetector {

    private static final String RULE_ID = "FORGEHUB-CWE-285-MISSINGFUNCTIONLEVELAUTHDETECTOR";
    private static final String CWE_ID = "CWE-285";
    ...
    private static final String DESCRIPTION = "Admin controller endpoint missing @PreAuthorize or hasRole annotation";

    private final Pattern pattern = Pattern.compile("(?i)(missingfunctionlevelauth|eval\\(|exec\\(|select|password)", Pattern.CASE_INSENSITIVE);
        ...
        for (int lineNum = 0; lineNum < lines.length; lineNum++) {
            ...
            if (matcher.find()) {
                findings.add(Finding.builder()
                        .ruleId(RULE_ID)
                        .title("MissingFunctionLevelAuth Vulnerability")
