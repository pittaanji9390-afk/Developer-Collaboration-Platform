...
/**
 * BrokenCookieFlagDetector
 * Security analyzer for CWE-614: Set-Cookie header missing HttpOnly, Secure, or SameSite attributes
 */
@Slf4j
@Component
public class BrokenCookieFlagDetector {

    private static final String RULE_ID = "FORGEHUB-CWE-614-BROKENCOOKIEFLAGDETECTOR";
    private static final String CWE_ID = "CWE-614";
    ...
    private static final String DESCRIPTION = "Set-Cookie header missing HttpOnly, Secure, or SameSite attributes";

    private final Pattern pattern = Pattern.compile("(?i)(brokencookieflag|eval\\(|exec\\(|select|password)", Pattern.CASE_INSENSITIVE);
        ...
        for (int lineNum = 0; lineNum < lines.length; lineNum++) {
            ...
            if (matcher.find()) {
                findings.add(Finding.builder()
                        .ruleId(RULE_ID)
                        .title("BrokenCookieFlag Vulnerability")
