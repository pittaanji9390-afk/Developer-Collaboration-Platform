...
/**
 * HibernateHqlInjectionDetector
 * Security analyzer for CWE-89: Dynamic HQL string concatenation in Session.createQuery
 */
@Slf4j
@Component
public class HibernateHqlInjectionDetector {

    private static final String RULE_ID = "FORGEHUB-CWE-89-HIBERNATEHQLINJECTIONDETECTOR";
    ...
    private static final String DESCRIPTION = "Dynamic HQL string concatenation in Session.createQuery";

    private final Pattern pattern = Pattern.compile("(?i)(hibernatehqlinjection|eval\\(|exec\\(|select|password)", Pattern.CASE_INSENSITIVE);
        ...
        for (int lineNum = 0; lineNum < lines.length; lineNum++) {
            ...
            if (matcher.find()) {
                findings.add(Finding.builder()
                        .ruleId(RULE_ID)
                        .title("HibernateHqlInjection Vulnerability")
