 ...
 * Security analyzer for CWE-601: Response.sendRedirect using raw query parameter destination
 */
@Slf4j
@Component
public class UnvalidatedRedirectDetector {

    private static final String RULE_ID = "FORGEHUB-CWE-601-UNVALIDATEDREDIRECTDETECTOR";
    ...
    private static final String DESCRIPTION = "Response.sendRedirect using raw query parameter destination";

    private final Pattern pattern = Pattern.compile("(?i)(unvalidatedredirect|eval\\(|exec\\(|select|password)", Pattern.CASE_INSENSITIVE);
        ...
        for (int lineNum = 0; lineNum < lines.length; lineNum++) {
            ...
            if (matcher.find()) {
                findings.add(Finding.builder()
                        .ruleId(RULE_ID)
                        .title("UnvalidatedRedirect Vulnerability")
