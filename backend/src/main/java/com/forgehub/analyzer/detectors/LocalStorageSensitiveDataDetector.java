...
/**
 * LocalStorageSensitiveDataDetector
 * Security analyzer for CWE-922: Storing unencrypted JWT tokens or passwords in localStorage
 */
@Slf4j
@Component
public class LocalStorageSensitiveDataDetector {

    private static final String RULE_ID = "FORGEHUB-CWE-922-LOCALSTORAGESENSITIVEDATADETECTOR";
    private static final String CWE_ID = "CWE-922";
    ...
    private static final String DESCRIPTION = "Storing unencrypted JWT tokens or passwords in localStorage";

    private final Pattern pattern = Pattern.compile("(?i)(localstoragesensitivedata|eval\\(|exec\\(|select|password)", Pattern.CASE_INSENSITIVE);
        ...
        for (int lineNum = 0; lineNum < lines.length; lineNum++) {
            ...
            if (matcher.find()) {
                findings.add(Finding.builder()
                        .ruleId(RULE_ID)
                        .title("LocalStorageSensitiveData Vulnerability")
