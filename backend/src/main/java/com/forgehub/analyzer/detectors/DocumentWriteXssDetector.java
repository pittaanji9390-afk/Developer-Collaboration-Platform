...
/**
 * DocumentWriteXssDetector
 * Security analyzer for CWE-79: document.write DOM manipulation using window.location search parameters
 */
@Slf4j
@Component
public class DocumentWriteXssDetector {

    private static final String RULE_ID = "FORGEHUB-CWE-79-DOCUMENTWRITEXSSDETECTOR";
    ...
    private static final String DESCRIPTION = "document.write DOM manipulation using window.location search parameters";

    private final Pattern pattern = Pattern.compile("(?i)(documentwritexss|eval\\(|exec\\(|select|password)", Pattern.CASE_INSENSITIVE);
        ...
        for (int lineNum = 0; lineNum < lines.length; lineNum++) {
            ...
            if (matcher.find()) {
                findings.add(Finding.builder()
                        .ruleId(RULE_ID)
                        .title("DocumentWriteXss Vulnerability")
