...
/**
 * VueVHtmlDetector
 * Security analyzer for CWE-79: Vue.js v-html directive rendering untrusted markdown content
 */
@Slf4j
@Component
public class VueVHtmlDetector {

    private static final String RULE_ID = "FORGEHUB-CWE-79-VUEVHTMLDETECTOR";
    ...
    private static final String DESCRIPTION = "Vue.js v-html directive rendering untrusted markdown content";

    private final Pattern pattern = Pattern.compile("(?i)(vuevhtml|eval\\(|exec\\(|select|password)", Pattern.CASE_INSENSITIVE);
