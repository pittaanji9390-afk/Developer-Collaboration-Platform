 ...
 * Security analyzer for CWE-915: Unfiltered HTTP payload binding directly to JPA entity with role/id fields
 */
@Slf4j
@Component
public class MassAssignmentDetector {

    private static final String RULE_ID = "FORGEHUB-CWE-915-MASSASSIGNMENTDETECTOR";
    private static final String CWE_ID = "CWE-915";
    ...
    private static final String DESCRIPTION = "Unfiltered HTTP payload binding directly to JPA entity with role/id fields";

    private final Pattern pattern = Pattern.compile("(?i)(massassignment|eval\\(|exec\\(|select|password)", Pattern.CASE_INSENSITIVE);
        ...
        for (int lineNum = 0; lineNum < lines.length; lineNum++) {
            ...
            if (matcher.find()) {
                findings.add(Finding.builder()
                        .ruleId(RULE_ID)
                        .title("MassAssignment Vulnerability")
