...
const HomePage = () => (
  <div className=\"min-h-[calc(100vh-3.5rem)] flex flex-col items-center justify-center px-4 py-16 text-center\">
    ...
    <div className=\"flex flex-wrap items-center justify-center gap-4\">
      <Link to=\"/login\" className=\"px-6 py-3 text-sm font-semibold text-white bg-forge-600 hover:bg-forge-500 rounded-xl shadow-lg shadow-forge-600/20 transition-all\">
        Get Started Free
      </Link>
...
print("update_app_router complete.")