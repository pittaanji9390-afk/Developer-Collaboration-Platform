...
# 1. PR DETAIL PAGE
pr_detail = """import React, { useState, useEffect } from 'react';
...
"""
write_file("frontend/src/features/pullrequests/PRDetailPage.tsx", pr_detail)

# 2. ISSUE DETAIL PAGE
issue_detail = """import React, { useState, useEffect } from 'react';
...
"""
write_file("frontend/src/features/issues/IssueDetailPage.tsx", issue_detail)

print("gen_feat_prs_issues complete.")